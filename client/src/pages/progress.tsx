            ...
            <div className="flex-1">
              ...
              {isCompleted && (
                <div className="mt-4 w-full flex justify-center">
                  <div className="p-4 bg-gradient-to-br from-yellow-200 to-yellow-300 rounded-2xl border border-yellow-400 w-full max-w-full shadow-sm text-center">
                    <div className="flex items-center justify-center gap-3 mb-3">
                      ...
                      <h4 className="text-yellow-900 font-semibold text-lg">
